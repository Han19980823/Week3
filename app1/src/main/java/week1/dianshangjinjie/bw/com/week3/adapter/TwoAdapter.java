 ...
 */
public  class TwoAdapter extends RecyclerView.Adapter<TwoAdapter.fisAdapter> {
    Context context;
    List<SQentity.ResultBean.CommunityCommentVoListBean> list;

    public TwoAdapter(Context context, List<SQentity.ResultBean.CommunityCommentVoListBean> list) {
    ...
    public fisAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view1 = LayoutInflater.from(context).inflate(R.layout.two_item_layout, parent, false);
